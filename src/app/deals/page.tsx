  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <p className="text-gray-600 mb-4">
        Compare {deals.length} deals from weekly flyers, daily deals, and digital coupons
        across Downtown Brooklyn. Updated daily.
      </p>
      <div className="bg-amber-50 border border-amber-200 rounded-lg px-4 py-3 mb-6 text-sm text-amber-900">
        <strong>How to read this page:</strong> We pull from store flyers, Target Circle deals, and digital coupons daily.
        Crossed-out prices show the average across all tracked stores so you can spot the best value.
      </div>
